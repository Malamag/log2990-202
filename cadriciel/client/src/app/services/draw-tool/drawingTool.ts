...
export abstract class DrawingTool extends InputObserver {
    ...
    constructor(
        ...
        this.chosenColor = { primColor: DEFAULTPRIMARYCOLOR, secColor: DEFAULTSECONDARYCOLOR, backColor: DEFAULTBACKCOLOR };
    }
    ...
    updateColors() {
        ...
        this.colorSub = this.colorPick.colorSubject.subscribe((color: ChoosenColors) => {
            if (color === undefined) {
